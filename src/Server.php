...
class Server{
	...
	public function __construct(
		...
		try{
			...
			$this->updater = new UpdateChecker($this, $this->configGroup->getPropertyString(Yml::AUTO_UPDATER_HOST, "update.betterlite.org"));
			...
			$splash = "\n\n";
			foreach([
				KnownTranslationFactory::pocketmine_server_url_discord("{$highlight}https://discord.betterlite.org{$reset}"),
				...
				KnownTranslationFactory::pocketmine_server_url_translations("{$highlight}https://translate.betterlite.org{$reset}"),
