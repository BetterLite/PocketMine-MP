...
This folder contains the files used to build and test the `ghcr.io/betterlite/pocketmine-mp` Docker image.
...
docker run -it -p 19132:19132/udp -v $PWD/data:/data -v $PWD/plugins:/plugins ghcr.io/betterlite/pocketmine-mp
```

To run a specific version, just add it to the end of the command, like this:
```
docker run -it -p 19132:19132/udp -v $PWD/data:/data -v $PWD/plugins:/plugins ghcr.io/betterlite/pocketmine-mp:5.46.0
```
...
dc20edd3dd62   ghcr.io/betterlite/pocketmine-mp:5.46.0   "start-pocketmine"       7 seconds ago   Up 6 seconds   19132/tcp, 0.0.0.0:19132-19133->19132-19133/udp, :::19132-19133->19132-19133/udp   brave_dijkstra
```
