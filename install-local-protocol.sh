...
composer require betterlite/bedrock-protocol:*@dev betterlite/bedrock-data:*@dev betterlite/bedrock-block-upgrade-schema:*@dev betterlite/bedrock-item-upgrade-schema:*@dev
